    ...
    <div class="container job_details_area">
        <div class="row pb-5">
            ...
            <div class="col-md-8">
                ...
                <!-- showing total Job Applicants only when user is logged in and showing it to user who have created that job -->
                    ...
                    <div class="descript_wrap white-bg">
                        <table class="table table-striped">
                            ...
                            @if($applications->isNotEmpty())
                                ...
                                @else
                                    <tr>
                                        <td colspan="3">No job applicants yet.</td>
                                    </tr>
                            @endif
                        </table>
                    </div>
            ...
            <!-- Right Sidebar Section (Summary and Company Details) -->
            <div class="col-md-4">
                    ...
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                ...
                                <li>Website: <span><b><a href="{{ $job->company_website }}">{{ $job->company_website }}</a></b></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
