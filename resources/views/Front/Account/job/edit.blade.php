        ...
        <div class="row">
            ...
            <div class="card border-0 shadow mb-4 ">
                    <div class="card-body card-form p-4">
                        <h3 class="fs-4 mb-1">JEditJob Details</h3>
                        <div class="row">
                        ...
                        <div class="mb-4">
                            <label for="" class="mb-2">Skills Required</label>
                            <input value="{{$job->keywords}}" type="text" placeholder="skills" id="keywords" name="keywords" class="form-control">
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="CompanyWebsiteLink" class="mb-2">Website</label>
...
// Removing errors for each field individually
...
// Handling error for 'description'
...
// Handling error for 'company_name'
