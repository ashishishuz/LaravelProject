                            ...
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    @if($savedJobs->isNotEmpty())
                                        ...
                                        <td>
                                            <div class="action-dots float">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" href="#" onClick="reomoveJob({{$savedJob->id}})"> <i class="fa fa-trash" aria-hidden="true"></i>Unsave</a></li>
                                        ...
                                        @else
                                        <tr> 
                                            <td colspan="5">You haven't Saved for any Job!</td>
                                        </tr>   
                                    @endif    
