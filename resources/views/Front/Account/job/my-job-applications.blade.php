                            ...
                            <table class="table ">
                                ...
                                <tbody class="border-0">
                                    @if($jobApplications->isNotEmpty())
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" href="#" onClick="reomoveJob({{$jobApplication->id}})"> <i class="fa fa-trash" aria-hidden="true"></i>Remove</a></li>
                                        ...
                                        @else
                                        <tr> 
                                            <td colspan="5">You haven't Applied for any Job!</td>
                                        </tr>   
                                    @endif    
...
function reomoveJob(id){
   if(confirm("Are you sure you want to remove?")){
    $.ajax({
        url:'{{ route("account.reomoveJobs") }}',
        type:'post',
        data:{id: id},
        dataType:'json',
